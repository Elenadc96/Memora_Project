// Dati mock usati finché il backend non espone tutte le API delle lezioni.
// Struttura speculare a quella che restituiranno i veri endpoint.
// Quando le API saranno pronte, eliminare questo file e rimuovere
// i riferimenti nello store.

export const mockLessons = {
  // Matematica (subject id: 1)
  1: [
